...
set qt_dir=C:\Qt\Qt5.12.0\5.12.0\mingw73_64\bin
set exe_dir=C:\Users\user\Documents\build-CompBootUpOrShutDownOnSchedule-Desktop_Qt_5_12_0_MinGW_64_bit-Debug\debug
set upx_dir=C:\upx
...
copy "%~1\libgcc_s_seh-1.dll" "%~2\" /B /V /Y
...
rem libgcc_s_seh-1.dll     72,5 КБ
